...
function DropdownMenuLabel({
  ...
  // Plain div, not Menu.GroupLabel: Base UI requires GroupLabel to live inside
  // a <Menu.Group>, but this is used as a standalone info header (e.g. user
  // name/email in a profile menu), not a heading over a set of grouped items.
  return (
    <div
