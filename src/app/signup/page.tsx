...
const FEATURES = [
  {
    ...
    description: "Connect Facebook and WhatsApp, pick a plan, and start capturing leads today.",
  },
  {
    icon: TrendingUp,
    title: "Never lose a lead",
    description: "Every submission lands in one dashboard, assigned and ready to follow up.",
  },
  {
    icon: ShieldCheck,
    title: "Cancel anytime",
    description: "No lock-in contracts — a simple monthly plan that scales with you.",
  },
];
  ...
  return (
    <div className="flex min-h-screen w-full">
      ...
      >
        ...
        <p className="relative text-xs text-white/60">Built for teams running ads on Meta</p>
      </div>
